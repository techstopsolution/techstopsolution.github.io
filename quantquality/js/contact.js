...
function validateForm() {
    ...
    if (question == "" || question == null) {
        document.getElementById('error-msg').innerHTML = "<div class='alert alert-warning error_message'>*Please enter a Question*</div>";
        fadeIn();
        return false;
    }
    ...
    xhttp.send("Name=" + name + "Company=" + company + "Number=" + number + "&email=" + email + "&subject=" + subject + "&Question=" + question);
